...
if(isset($_POST['username']))
  {
    ...
    $query="SELECT Staff_Email, staff_passhash from staff where Staff_Email='".$adminuser."'";
    $result=mysqli_query($con,$query);
    list($staff_email, $staff_pass)=mysqli_fetch_array($result);
    if (password_verify($password, $staff_pass)){
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h3 style="color: white">Pencatatan PT. MOO</h3>
                    <hr  color="red"/>
                </div>
