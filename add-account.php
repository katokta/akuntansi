...
if (isset($_POST['headingakun'])){
    ...
    if ($headingakun==""){
        ...
        $result=mysqli_query($con, "INSERT INTO akun_perkiraan VALUES (null, '".$headingakun."', '".$subheadingakun."', '".$deskripsiakun."', '".$namastaff."')");
...
<head>
    ...
    <title>Food-Taker Add Accounts</title>
                            ...
                            <div class="card-body card-block">
                                ...
                                <select name="headingakun" id="headingakun">
                                  ...
                                  <option value="Beban">Beban</option>
                                        ...
                                        <div class="form-group"><label for="street" class=" form-control-label">Sub Heading Account</label><input type="text" name="subheadingakun" value="" id="comploc" class="form-control" required="true"></div>
                                        <div class="form-group"><label for="street" class=" form-control-label">Account Description</label><input type="text" name="descakun" value="" id="comploc" class="form-control" required="true"></div>
